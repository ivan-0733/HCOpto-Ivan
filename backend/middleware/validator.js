...
const loginAlumnoRules = [
  body('boleta')
    .notEmpty().withMessage('La boleta es requerida')
    .isLength({ min: 10, max: 10 }).withMessage('La boleta debe tener 10 caracteres'),
...
/**
 * Reglas de validación para el inicio de sesión de profesores
 */
const loginProfesorRules = [
  body('numeroEmpleado')
